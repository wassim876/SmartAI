          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                // Table Content
                if (authProvider.isLoading && _filteredUsers.isNotEmpty)
                  const Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  flex: 3,
                                  child: _buildTableHeader('USER', isDark),
                                ),
                                Expanded(
                                  flex: 2,
                                  child: _buildTableHeader('EMAIL', isDark),
                                ),
                                Expanded(
                                  flex: 1,
                                  child: _buildTableHeader('ROLE', isDark),
                                ),
                                Expanded(
                                  flex: 1,
                                  child: _buildTableHeader('STATUS', isDark),
                                ),
                                Expanded(
                                  flex: 1,
                                  child: _buildTableHeader('ACTIONS', isDark),
                                ),
                              ],
                            ),
                          ),
                          ...
                          ..._filteredUsers.map(
                            (user) => _buildUserRow(user, isDark),
                          ),
                        ],
                      ),
                    ),
